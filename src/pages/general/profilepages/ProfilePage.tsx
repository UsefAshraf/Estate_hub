...
import  type { RootState } from "src/redux/store";     // ⭐ ADDED
import { Link } from "react-router-dom";           // ⭐ ADDED

import { User, Mail, Phone, MapPin, Heart, Calendar, History, Settings } from "lucide-react";
import { useState } from "react";

export default function SimpleProfilePage() {
  const user = useSelector((state: RootState) => state.user); // ⭐ ADDED
