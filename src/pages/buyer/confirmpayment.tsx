...
export default function PaymentSuccessPage() {
  ...
  // Generate a display-friendly transaction ID
  const displayTransactionId = paymentData?.paymentIntentId
    ? `TXN-${paymentData.paymentIntentId.slice(-8).toUpperCase()}`
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-start">
                  ...
                  <span className="text-gray-900 font-semibold text-right max-w-xs">
                    {paymentData?.property?.title || "Property Purchase"}
                  </span>
                </div>
          ...
          <div className="bg-gray-50 p-6 border-t border-gray-100 text-center">
            <p className="text-sm text-gray-500">
              ...
              <a
                ...
                className="text-[#C19A6B] hover:underline font-medium"
              >
