...
import type { Favorite, Property } from "../../types/favourites.types.js";
...
const FavouritesBuyer: React.FC = () => {
  ...
  const shareProperty = (property: Property) => {
    navigator.clipboard.writeText(`${property.title} - ${property.location}`);
      ...
      <section className="max-w-7xl mx-auto px-6 py-12">
        {favorites.length === 0 ? (
          <div className="text-center py-20">
            ...
            <h2 className="text-2xl font-bold text-primary">No Favorites Yet</h2>
          </div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {favorites.map((fav) => (
              <FavoriteCard
                key={fav._id}
                property={{ ...fav.propertyId, dateAdded: fav.createdAt }}
