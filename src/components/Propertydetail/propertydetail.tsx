...
const Propertydetail: React.FC = () => {
  ...
  const propertyData: PropertyData = {
    ...
    built: 2022,
    description:
      "Stunning modern villa featuring contemporary architecture, expansive living spaces, and a beautiful infinity pool. This property offers the ultimate in luxury living with high-end finishes throughout.",
    features: [
              ...
              <div className="flex items-start justify-between mb-4">
                <div>
                  <div className="flex items-center space-x-2 mb-2">
                    ...
                    <span className="bg-orange-500 text-white text-s px-3 py-1 rounded-full">
        ...
        <div className="fixed inset-0 bg-black/10 backdrop-blur-[1px] flex items-center justify-center z-50 p-4">
          <div className="bg-primary rounded-xl shadow-2xl max-w-md w-full p-6 relative bg-secondary">
            ...
            <h2 className="text-xl font-bold text-secondary mb-6">
              Contact {propertyData.agent.name}
            </h2>
